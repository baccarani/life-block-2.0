...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function transferFrom(
        ...
        require(false, "Soulbound Token (SBT) is not working from transferFrom");
    ...
    function safeTransferFrom(
        ...
        require(false, "Soulbound Token (SBT) is not working from safeTransferFrom");
    ...
    function safeTransferFrom(
        ...
        require(false, "Soulbound Token (SBT) cannot be transferred from safeTransferFrom");
...
// File: contracts/DeathCertificate.sol
...
contract DeathCertificate is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Death Certificate", "Life Block") {}
